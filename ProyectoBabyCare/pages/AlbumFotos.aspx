    ...
    <div style="background-color: #F6E0ED";>
        <form runat="server">
            <div id="filtro" class="row" style="color: mediumblue;font-family: 'Baloo 2', sans-serif">
                <div style="width: 15%;margin-left:20%;text-align:center">
                    <div>
                ...
                <div style="width: 15%;margin-left:5%;text-align:center">
                    <div>
                ...
                <div style="width: 30%">
                    <asp:Button ID="btnFiltrar" class="btn btn-primary profile-button" runat="server" Text="Filtrar" OnClick="btnFiltrar_Click" />
                </div>
            </div>
